...
"$the_aws_login_root_dir/scripts/aws-run-cmd.sh" aws sso login --no-browser

# run again to show the login info
[ x"$AWS_LOGIN_OPTION_SHOW_LOGIN_INFO" = x1 ] && "$the_aws_login_root_dir/scripts/aws-run-cmd.sh" aws sts get-caller-identity
